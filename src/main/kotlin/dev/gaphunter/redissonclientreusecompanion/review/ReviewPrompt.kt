package dev.gaphunter.redissonclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.redissonclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.redissonclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Redisson Client Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33895-redisson-client-reuse-companion/reviews"
